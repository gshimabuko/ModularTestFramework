...
{
    public class TestAppExpensesPage : BasePage
    {
        ...
        public TestAppExpensesPage(IWebDriver driver) => _driver = driver;
        ...
        {
            IWebElement createdCategoryDetails = _driver.FindElement(By.XPath($"//*[contains(text(),\"{account}\")]/../td[4]/a[2]"));
